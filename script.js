...
function getPosts(reload = true, page = 1) {
  axios.get(`${baseURL}/posts?limit=10&page=${page}`).then((response) => {
    ...
    for (let x = 0; x < posts.length; x++) {
      ...
      <button class="btn btn-primary" onclick="editPost()" data-bs-toggle="modal" data-bs-target="#edit-post-modal"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
